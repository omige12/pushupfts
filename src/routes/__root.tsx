...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Flex Battle — Arena de Flexões com IA" },
      { property: "og:description", content: "Conte flexões automaticamente com IA pela câmera, duele em tempo real contra amigos e suba no ranking global." },
      { property: "og:site_name", content: "Flex Battle" },
